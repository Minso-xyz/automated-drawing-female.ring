...
Public Class Form1
    ...
    Public Sub button_ok_Click(sender As Object, e As EventArgs) Handles button_ok.Click
        ...
        ' Get the parameter named "radius1_parameter"
        Dim oRadius1Param As Inventor.Parameter
        oRadius1Param = params.Item("radius1_parameter")

        ' Get the parameter named "radius2_parameter"
        Dim oRadius2Param As Inventor.Parameter
        oRadius2Param = params.Item("radius2_parameter")
        ...
        ' Set the range of "Radius1" & "Radius2"
        If fascia <= 5 Then
            radius1 = 1
            radius2 = 0.5
        ElseIf fascia > 5 And fascia <= 7 Then
            radius1 = 1
            radius2 = 1
        ElseIf fascia > 7 And fascia <= 9 Then
            radius1 = 1
            radius2 = 1.5
        ElseIf fascia > 9 And fascia <= 10.25 Then
            radius1 = 1
            radius2 = 2
        ElseIf fascia > 10.25 And fascia <= 13.5 Then
            radius1 = 1.5
            radius2 = 2
        ElseIf fascia > 13.5 And fascia <= 17.75 Then
            radius1 = 1.5
            radius2 = 3
        ElseIf fascia > 17.75 And fascia <= 22.2 Then
            radius1 = 2
            radius2 = 3
        ElseIf fascia > 22.2 And fascia <= 22.9 Then
            radius1 = 2.5
            radius2 = 3
        ...
        oRadius1Param.Expression = radius1
        oRadius2Param.Expression = radius2
